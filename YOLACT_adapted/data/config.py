...
train_images = Path(r'Path to images used during the training of the network - Annotated images for instruments and retinal elements')
train_info = Path(r'.json generated by CVAT tool, with bounding box and masks for the dataset')
#Same but for validation dataset
valid_images = Path(r'')
valid_info = Path(r'')
...
multi_retina = dataset_base.copy({
    ...
    'test_info': test_info,
    'has_gt': True,
    'class_names': ('Vitrector_tooltip', 'Membrane_forceps_tooltip', 'Endolaser_tooltip', 'Optic_disc')
})
