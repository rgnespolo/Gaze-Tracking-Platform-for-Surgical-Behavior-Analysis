...
# python eval.py --trained_model=weights/multi_retina_203_5500.pth --config=yolact_base_config --score_threshold=0.5 --top_k=5 --video_multiframe=1 --video=surgical_case.avi
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=True, mask_alpha=0.2, fps_str=''):
    ...
    with timer.env('Postprocess'):
        ...
        # masks are returned as image, boxes as coordinates

    with timer.env('Copy'):
        # Finding the top prediction for each class
    ...
    # Draw the masks on the GPU where we can do it really fast
    ...
    if args.display_text or args.display_bboxes:
        for j in reversed(range(num_dets_to_consider)):
            ...
            #Visualizing each detected instrument or retina element
            # print('\n-----------------------------------------')
            ...
            # for loop to save the centroid of each element detected to a .csv file
